...
String SendHTML(float tempSensor1, String statusStr)
{
  ...
  ptr +=  "</div>";
  ptr +=  "<button onclick=\"switchOn()\">On</button>";
  ptr +=  "<script>\n";
  ptr +=    "function switchOn() {\n";
  ptr +=    "document.getElementById(\"demo\").innerHTML = \"In switchOn\"\n";
  ptr +=    "digitalWrite(RELAY_BUS, HIGH)\n";
  ptr +=    "}\n";
  ptr +=  "</script>\n";

  ptr +=  "<button onclick=\"switchOff()\">Off</button>";
  ptr +=  "<script>\n";
  ptr +=    "function switchOff() {\n";
  ptr +=    "document.getElementById(\"demo\").innerHTML = \"In switchOff\"\n";
  ptr +=    "digitalWrite(RELAY_BUS, LOW)\n";
  ptr +=    "}\n";
  ptr +=  "</script>\n";
